...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      " inline-block text-sm bg-transparent rounded-full border-2 font-semibold border-stone-300 px-4 py-2.5 md:py-3.5 md:px-6 hover:bg-stone-300 text-stone-400 hover:text-stone-800 focus:ring focus:ring-stone-200 focus:ring-offset-2 focus:bg-stone-300 focus:ring-offset-2 uppercase",
  };
